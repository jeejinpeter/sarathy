    ...
    <tbody style="background:white;"> 
     ...
     <tr> 
	  <td class="center"><?php echo $i++; ?></td>
        <td class="center"><a style="color:red;" target="_blank" href="<?php echo base_url('Staff/invoice_pdf_prev_bill_insura/'.$row->inv_id); ?>"><?php echo $row->in_registr; ?></a><br> <?php echo $row->inv_cus; ?><br><?php echo $row->inv_cus_addres; ?><br><?php echo $row->inv_pho; ?></td>
