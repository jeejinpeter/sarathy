...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="<?php echo  base_url('Staff/staff_home_page');?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>  <a href="<?php echo  base_url('Staff/add_customer');?>" class="current">Add Customer</a> </div>
        ...
        <div class="row-fluid">
                ...
                <div class="widget-box" style="margin-top:-25px;">
                    ...
                    <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                     ...
                     <a class="btn btn-danger pull-right" href="<?php echo base_url('Staff/list_customer');?>"><b>List Customer</b></a>

                    </div>
                    <div class="widget-content nopadding">
                        <form action="<?php 
                echo  base_url('Staff/customer_add');?>" method="post" class="form-horizontal" name="add">
...
function valid(){
    ...
    var mode=/^[0-9\A-Za-z\" "\.\-]+$/;
      ...
      /*   else if(model == ""){
        ...
        document.add.c_m.focus();
        return false;
       }

       else if(!model.match(mode)){
