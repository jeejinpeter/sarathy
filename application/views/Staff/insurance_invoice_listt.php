...
<div id="content">
  <div id="content-header">
       <div id="breadcrumb"> <a href="<?php echo  base_url('Staff/admin_home_page');?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="#" class="current">List Ready for Bill</a> </div>  </div>
    ...
    <tbody style="background:white;"> 
     ...
     <tr> 
	  <td class="center"><?php echo $i++; ?></td>
       <form action="<?php 
                echo  base_url('Staff/edit_insurance_invoice');?>" method="post" name="all-<?php echo $i;?>" class="form-horizontal">  
