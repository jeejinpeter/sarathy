...
<div id="content">
  <div id="content-header">
       <div id="breadcrumb"> <a href="<?php echo  base_url('Staff/staff_home_page');?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="#" class="current">List Ready for Bill</a> </div>  </div>
  ...
  <div class="container-fluid">
    ...
    <div class="span12">	
		...
		<div style="background-color: #e6e6e6;margin-top:-10px;" class="widget-title">
            <h5 style="color:#000;"> Ready for Bill List(Labour)</h5>
			<!--<div class="btn" style="float:right;margin:3px; background:red;"><a class="btn-btn-danger" style="color:white!important;" href="<?php echo base_url('Admin/invoice_labour');?>"> Add Labour Invoice</a></div>-->
          </div>  
    ...
    <tbody style="background:white;"> 
     ...
     <tr> 
	  <td class="center"><?php echo $i++; ?></td>
        <form action="<?php 
                echo  base_url('Staff/edit_invoice');?>" method="post" name="all-<?php echo $i;?>" class="form-horizontal">  
		...
		<br> &nbsp; <?php echo $row->inv_cus; ?><br>&nbsp;&nbsp;<?php echo $row->inv_cus_addres; ?><br>&nbsp;&nbsp;<?php echo $row->inv_pho; ?></td>	
 </form>	 
 <td class="center"><?php echo $row->branch_name; ?></td>
	...
	<!--<a class="btn btn-danger dropdown-toggle" href="<?php echo base_url('Admin/edit_invoice/'.$row->inv_id); ?>" style="border-radius:10px; margin-left:8px;">Print</a>-->
