...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="" class="tip-bottom">List Customer</a> <a href="#" class="current">Edit Customer</a> </div>
        ...
        <div class="row-fluid">
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form action="<?php 
                echo  base_url('Staff/customer_edit');?>" method="post" class="form-horizontal" name="add">
