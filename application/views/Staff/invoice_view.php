...
<div id="content">
 ...
 <div id="content" style="zoom:100%;">         
                <div class="widget-box">
				 <form action="<?php 
                echo  base_url('Staff/add_invoice_spare');?>" method="post" class="form-horizontal">
				 ...
				 <div class="span3">
				  <div class="control-group">
								...
								<input type="text" style="font-size:9px;" name=""  placeholder="" value="<?php echo $branchname;?>" required readonly />
								<input type="hidden" name="branchname"  id="branch" value="<?php echo $brancid;?>" required readonly />
								</div>								
                            </div>
				    <div class="control-group">
                           ...
                           <div class="control-group">
							 ...
							 <div id="msg"></div>
                                ...
                                <div class="controls" style="margin-left:130px">
                                    <input style="font-size:11px;" type="text" name="invoic" id="invoiceno" placeholder="" value="" readonly required />
 	  ...
 	  <div class="control-group">
				    ...
				    <div class="control-group">
							...
							<div class="control-group">
                                ...
                                <div class="controls" style="margin-left:130px">
                                    <input style="font-size:10px;" type="text" name="cusname" id="cusname"  placeholder="" value="" readonly />
							...
							<div class="control-group">
                                ...
                                <div class="controls" style="margin-left:130px">
                                    <input type="number" name="cusph" id="cusph"  placeholder="" value="" required />
							...
							<div class="control-group">
                                ...
                                <div class="controls" style="margin-left:130px">
                                    <input type="text" id="gstinc" name="cusgst"  placeholder="" value="" readonly />
                                ...
                                <div class="controls" style="margin-left:130px">
                                    <textarea style="height:60px;resize:none;font-size:12px;" name="cusaddr" id="address" rows="4" readonly ></textarea>
								 </div>								
                            </div>
									</div>
 ...
 <div class="control-group">
                                ...
                                <div class="controls" style="margin-left:130px">
									<select name="repairty" required style="width:165px;font-size: 11px;" required>
							...
							<div class="control-group">
                                ...
                                <div class="controls" style="margin-left:128px">
								<select name="advname" id="Adviz"  style="width:165px;font-size: 11px;">
								<option value="">--Select--</option>
								<?php
								foreach($adv as $row)
								{
								?>
								<option value="<?php echo $row->emp_id?>"><?php echo $row->e_first_name?></option>
								<?php
								}
								?>
								</select>
							...
							<div class="control-group">
								...
								<select class="mecha" id="Mechz" name="mechname" style="width:165px;font-size: 11px;" >
								<option value="">--Select--</option>
								<?php
								foreach($mec as $row)
								{
							...
							<div class="control-group">
                                ...
                                <div class="controls" style="margin-left:130px">
                                    <input type="date" id="saledate" name="saledate"  placeholder="" value="" readonly />
                ...
                <textarea name="c_address" class="form-control span11"  placeholder="Customer address" id="cusadd"></textarea>
                  ...
                  <span class="text-danger"><?php echo form_error('c_g_no'); ?></span>
								...
								<div class="span6 pull-right">
								 <div class="form-group" id="locationCodesParent">
                                <label>Model Name :</label>
                                    <select class="item1" id="cusmodel" name="c_m"  id="ins"  style="width:230px;border-radius:0px;margin-left:200px"  >
                                        <option value="">--Select--</option>
                                        <?php
