...
<div id="content" >
  <div id="content-header">
        <div id="breadcrumb"> <a href="<?php echo  base_url('Staff/staff_home_page');?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>Home</a><a href="#" class="current"> List JobCard Statement</a> </div>
    </div>
      ...
      <div class="widget-box span12">
          <div class="widget-title">
		   ...
		   <?php $attributes = array("name" => "complete");
                               echo form_open("Staff/list_job_card_statement_proccessing", $attributes);
							   ?>
...
<button onclick="fun()" formtarget="_blank" value="EXCEL"  style="margin-left: 1223px;margin-top:-59px;" class="btn btn-danger" name="excel">EXCEL</button>
		   ...
		   <div class="widget-content nopadding" >
			 ...
			 <select name="branch" class="span5" style="font-size:12px;" id="branch" readonly>
...
<div class="controls" style="margin-left:70px;">
	 ...
	 <th><input type="text" name="job" style="width:70px;font-size:11px;" value="Insurance Company" readonly></th>
...
<div class="col-md-12">
 <div class=" col-md-3" style="margin-left:437px;margin-top:-44px"><b><label><b>Total Taxable Amount</b></label></div><div class=" col-md-6"><input type="text" style="width:139px;margin-left:584px;margin-top:-50px" class="form-control" id="grand_total_tax" readonly value=""></b></div>
   ...
   <!--div class=" col-md-3" style="margin-left:135px;margin-top:-44px"><b><label><b>No.of Labour Codes </b></label></div><div class=" col-md-6"><input type="text" style="width:139px;margin-left:278px;margin-top:-50px" class="form-control" id="grand_total_sgst" readonly value=""></b></div-->
  </div>
    ...
    table = $('#user_data').DataTable({ 
        ...
        "ajax": {
            ...
            "data": function ( data ) {
				...
				//data.labourcode = $('#labour_code').val();
...
$('#branch,#repair_type,#view_service,select[name="code[]"],select[name="advisor[]"],select[name="mech[]"],#fromdate,#view_by,#todate').on('change', function () 
