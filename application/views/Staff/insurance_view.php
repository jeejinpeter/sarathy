...
<div id="content">
 ...
 <div id="content" style="zoom:100%;"> 
  <form action="<?php 
                echo  base_url('Staff/invoice_insurance_process');?>" method="post" class="form-horizontal"> 
                <div class="widget-box">
				 ...
				 <div class="control-group">
								...
								<input type="text" name="" style="font-size:11px;"  placeholder="" value="<?php echo $branchname;?>" required readonly />
 ...
 <div class="span3">
  <div class="control-group">
                             ...
                             <div class="control-group">
                                ...
                                <div class="controls" style="margin-left:128px">
								<select class="mecha" name="mechname" id="Mechz" style="width:165px;">
								<option value="">--Select--</option>
								<?php
								foreach($mec as $row)
								{
