...
<div id="content" >
  <div id="content-header">
        <div id="breadcrumb"> <a href="<?php echo  base_url('Staff/staff_home_page');?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>  <a href="#" class="current">List List JobCard</a> </div>
    </div>
...
<div class="row-fluid">
   ...
   <div class="span12 " style="margin-top:-45px;">
       ...
       <div class="widget-box span12">
          <div class="widget-title">
		   ...
		   <?php $attributes = array("name" => "complete");
                               echo form_open("staff/list_custom_date_staff", $attributes);
							   ?>
	  ...
	  <!--<button onclick="fun()"  value="CSV" formtarget="_blank" style="margin-left: 1173px;margin-top:-60px;" class="btn btn-danger" name="csv">CSV</button>--> 
<button onclick="fun()" formtarget="_blank" value="EXCEL"  style="margin-left: 1223px;margin-top:-56px;" class="btn btn-danger" name="excel">EXCEL</button>
		   ...
		   <div class="widget-content nopadding" >
			 ...
			 <div class="span6 offset3">
                ...
                <div class="controls" style="margin-left:73px;">
...
<div class="controls" style="margin-left:70px;">
         ...
         <div class="" style="width:100%;overflow-x:scroll; height:500px;overflow-y:scroll;">
 ...
 <th><input type="text" name="job" style="width:70px;font-size:11px;" value="Invoice Amount" readonly></th>	  
			 ...
			 <div class="col-md-12">
 <div class=" col-md-3" style="margin-left:1000px;padding-top: 7px;"><b><label><b>Total GST Amount</b></label></div><div class=" col-md-6"><input type="text" style="width:139px;margin-left:1150px;margin-top:-50px" class="form-control" id="grand_total_gst" readonly value=""></b></div>
  </div>
	 <div class="col-md-12">
