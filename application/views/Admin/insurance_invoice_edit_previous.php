...
<div id="content">
 ...
 <div id="content" style="zoom:100%;">  
  <form action="<?php echo base_url('Admin/invoice_insurance_editprevious');?>" method="post" class="form-horizontal" target="_blank"> 
				  ...
				  <div class="control-group">
				    ...
				    <div class="control-group">
                           ...
                           <div class="control-group">
							...
							<input type="text" name="rno" id="reg" onblur="reg_number();" value="<?php echo $row->in_registr ;?>" />
				   ...
				   <div class="control-group">
                    ...
                    {?>
     <option value ="<?php echo $rowss['com_id']; ?>"><?php echo $rowss['icompany_name']; ?></option>
       <?php
                     }
                     ?>
                                    </select>
							...
							<div class="control-group">
                                ...
                                <div class="controls" style="margin-left:130px">
                                  <input type="text" id="cusgst" name="cusgst" value="<?php echo $row->icompany_gst ;?>" readonly />
                                ...
                                <div class="controls" style="margin-left:130px;">
                                  <textarea style="height:60px;resize:none;" name="cusaddr" id="cusaddr" rows="4" readonly ><?php echo $row->icompany_address ;?></textarea>
								 </div>								
                            </div>
									</div>
 ...
 <div class="control-group">
                             ...
                             <div class="controls" style="margin-left:130px">
                                   <input type="text" name="cusph" id="cusph" value="<?php echo $row->inv_pho ;?>"  />
                                </div>								
                            </div>
 <div class="control-group">
