...
<div id="content">
 ...
 <form action="<?php echo base_url('Admin/invoice_pdf_ready');?>" method="post" class="form-horizontal" target="_blank"> 
				 ...
				 <div class="span3">
				  <div class="control-group">
				    ...
				    <div class="control-group">
                               ...
                               <div class="controls" style="margin-left:130px">
                                     <input type="text" id="jobcard" name="jno" value="<?php echo $row->inv_job_card_no ;?>"   />  
									  <input type="hidden" name="jnoss" value="<?php echo $row->inv_job_card_no ;?>"/>
									 </div>	
<div id="fetch" style="color:red;">	</div>								 
                            </div>
        ...
        if(ID){
            $.ajax({
                type:'POST',
                url:'checjobcrd_labour',
                data:'id='+ID,
                success:function(html){
					result = $.parseJSON(html);
       if(result.status){
		window.location.reload();
		$('#fetch').html("Job card entered already exists. Please enter another one.");
       } 
	   }
				
            }); 
        }else{
            $('#fetch').html("<p>Please enter a valid jobcard number</p>");
			window.location.reload();
        }
    });   
						...
						<input type="text" name="cno"  value="<?php echo $row->inv_chassis ;?>" readonly />
                         ...
                         <input type="text" name="cusname"  value="<?php echo $row->inv_cus ;?>" readonly />
							...
							<div class="control-group">
                                ...
                                <div class="controls" style="margin-left:130px">
                                <input type="number" name="cusph"  value="<?php echo $row->inv_pho ;?>"  />
							...
							<div class="control-group">
                                ...
                                <div class="controls" style="margin-left:130px">
                                  <input type="text" name="cusgst" value="<?php echo $row->inv_cus_gstin ;?>" readonly />
                                ...
                                <div class="controls" style="margin-left:130px">
                                  <textarea name="cusaddr" style="height:61px;resize:none;" rows="4" readonly ><?php echo $row->inv_cus_addres ;?></textarea>
								 </div>								
                            </div>
									</div>
