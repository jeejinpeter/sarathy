...
<div id="content">
 ...
 <div id="content" style="zoom:100%;">  
  <form action="<?php echo base_url('Admin/invoice_insurance_pdf_ready');?>" method="post" class="form-horizontal" target="_blank"> 
				 ...
				 <div class="span3">
				  <div class="control-group">
				    ...
				    <div class="control-group">
                               ...
                               <div class="controls" style="margin-left:130px">
                                     <input type="text" id="jobcard" name="jno" value="<?php echo $row->inv_job_card_no ;?>" value="" />  </div>								
						...
						<input type="text" name="cno"  value="<?php echo $row->inv_chassis ;?>" readonly />
                         ...
                         <input type="text" name="cusname"  value="<?php echo $row->inv_cus ;?>" readonly />
							...
							<div class="control-group">
                                ...
                                <div class="controls" style="margin-left:130px">
                                <input type="text"   name="ins_id" value="<?php echo $row->icompany_name ;?>" readonly />
							...
							<div class="control-group">
                                ...
                                <div class="controls" style="margin-left:130px">
                                  <input type="text"  name="cusgst" value="<?php echo $row->icompany_gst ;?>" readonly />
                                ...
                                <div class="controls" style="margin-left:130px;">
                                  <textarea style="height:60px;resize:none;" name="cusaddr" rows="4" readonly ><?php echo $row->icompany_address ;?></textarea>
								 </div>								
                            </div>
									</div>
