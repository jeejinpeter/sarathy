...
<div id="content">
 ...
 <div id="content" style="zoom:100%;">         
                <div class="widget-box">
				 <form action="<?php 
                echo  base_url('Admin/add_invoice_spare');?>" method="post" class="form-horizontal">
 	  ...
 	  <div class="control-group">
								...
								<input type="text" class="input_capital" name="rno"  id="reg" onblur="reg_number();" required />
                                </div>								
                            </div>
						 <div class="control-group">
 ...
 <div class="control-group">
							...
							<div class="control-group">
								...
								<select class="mecha" name="mechname" id="Mechz"  style="width:165px;font-size: 11px;" >
								<option>--Select--</option>
