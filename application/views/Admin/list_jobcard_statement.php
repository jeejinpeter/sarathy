...
<div id="content" >
  <div id="content-header">
        <div id="breadcrumb"> <a href="<?php echo  base_url('Admin/admin_home_page');?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="#" class="current"> List JobCard Statement</a> </div>
    </div>
...
<div class="span12 " style="margin-top:-45px;">
      <div class="widget-box span12">
          <div class="widget-title">
            ...
            <h5>List JobCard Statement</h5>
			<br><br>
			</div>
		   <?php $attributes = array("name" => "complete");
                               echo form_open("Report/list_job_card_statement_proccessing", $attributes);
							   ?>
<button onclick="fun()" formtarget="_blank" value="EXCEL"  style="margin-left: 1223px;margin-top:-59px;" class="btn btn-danger" name="excel">EXCEL</button>
...
<div class="controls" style="margin-left:70px;">
				...
				<div>
				 ...
				 <!--<div class="span12" >
						 ...
						 <div class="span3 offset3">
							<div class="control-group">
                                ...
                                <div class="controls">
								Date From&nbsp;&nbsp;&nbsp;<input style="font-size:11px;"  type="date" name="from" class="span6" <?php if(isset($fromdate)) { ?> value="<?php echo $fromdate?>" <?php } ?> placeholder="" onchange="fun()" required />
									<span class="text-danger"><?php echo form_error('from'); ?></span>
                                </div>
                            </div>
							</div>
							<div class="span3">
							 <div class="control-group" >
                                ...
                                <div class="controls">
								Date To&nbsp;&nbsp;&nbsp;<input  style="font-size:11px;" type="date" name="to" class="span6" <?php if(isset($todate)) { ?> value="<?php echo $todate?>" <?php } ?> placeholder=""  required />
                                </div>
                            </div>
				 ...
				 <?php //} else {?>
				  <div class="span4 offset2">
							<div class="control-group">
                                ...
                                <div class="controls">
								Date From&nbsp;&nbsp;&nbsp;<input style="font-size:11px;" type="date" name="from" class="span6" <?php if(isset($fromdate)) { ?> value="<?php echo $fromdate?>" <?php } ?> placeholder=""  required / readonly>
									<span class="text-danger"><?php echo form_error('from'); ?></span>
                                </div>
                            </div>
							</div>
							<div class="span4">
							 <div class="control-group" >
                                ...
                                <div class="controls">
								Date to&nbsp;&nbsp;&nbsp;<input style="font-size:11px;" type="date" name="to" class="span6" <?php if(isset($todate)) { ?> value="<?php echo $todate?>" <?php } ?> placeholder=""  required /readonly>
                                </div>
                            </div>
				 ...
				 <?php //} ?>
         <div clas="" style="overflow-x:scroll;overflow-y:scroll; width:100%;height:400px;">
		  ...
		  <table  id="user_data" class="table table-bordered " >
              <thead>
				...
				<th>
               <select name="code[]" multiple class="selectpicker3" style="width:100px;font-size:11px;">
					...
					{
					?>
									<option value="<?php echo $row->labour_code;?>"><?php echo $row->labour_title;?>(<?php echo $row->labour_code;?>)</option>
									<?php 
					}
                                ?>
                   </select>
				...
				<!-- <th>
                  <select name="emp">
					...
					foreach($vehicle_model as $row1)
					{
					?>
									<option value="<?php echo $row1['model_name']?>"><?php echo $row1['model_name']?></option>
									<?php 
					}
                                ?>
                   </select>
...
<div class="col-md-12">
 <div class=" col-md-3" style="margin-left:437px;margin-top:-44px"><b><label><b>Total Taxable Amount</b></label></div><div class=" col-md-6"><input type="text" style="width:139px;margin-left:584px;margin-top:-50px" class="form-control" id="grand_total_tax" readonly value=""></b></div>
   ...
   <div class=" col-md-3" style="margin-left:135px;margin-top:-44px"><b><label><b>No.of Labour Codes </b></label></div><div class=" col-md-6"><input type="text" style="width:139px;margin-left:278px;margin-top:-50px" class="form-control" id="lab_code" readonly value=""></b></div>
  </div>
...
//$('.selectpicker3').select2({placeholder: "--Select Labour Code --",closeOnSelect: false}).on("change", function(e) {
...
// {
 ...
 // }
//else{
// $('.select2-selection__rendered').after('<div style="padding:2px;font-size:14px;" class="counter">'+counter+' selected</div>');
//}
//});
    ...
    table = $('#user_data').DataTable({ 
        ...
        "ajax": {
            ...
            "data": function ( data ) {
				...
				data.labourcode = $('select[name="code[]"]').val();
...
$('#branch,#repair_type,#view_service,select[name="code[]"],select[name="advisor[]"],select[name="mech[]"],select[name="ins_company[]"],#fromdate,#view_by,#todate').on('change', function () 
...
total()
   ...
   $( '.selectpicker3' ).multiselect({
       nonSelectedText:'--Select Labour Code--',
       numberDisplayed:2
   });
