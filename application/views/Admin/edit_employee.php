...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="<?php echo  base_url('Admin/admin_home_page');?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="<?php echo  base_url('Admin/list_employee');?>" class="tip-bottom">List Employee</a> <a href="#" class="current">Edit Employee</a> </div>
    ...
    <div class="container-fluid">
        <div class="row-fluid">
                ...
                <div class="widget-box">
					...
					<div class="span12">
                        <form action="<?php 
                echo  base_url('Admin/employee_update_processing');?>" method="post" class="form-horizontal">
...
<br>				  
		...
		<option value="Ms.">Ms.</option>
					...
					<div class="control-group">
                                ...
                                <div class="controls">
								 <textarea name="address" rows="4" class="span11" placeholder="Address" ><?php echo $row->e_address; ?></textarea>
...
<br>
						      ...
						      <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="u_phone" class="span11" placeholder="" value="<?php echo $row->e_mobile; ?>" />
							 ...
							 <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="email" name="u_email" class="span11" placeholder="" value="<?php echo $row->e_email; ?>" />
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="username" class="span11" value="" />
							 ...
							 <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="password" name="password" class="span11" placeholder="" value="" />
