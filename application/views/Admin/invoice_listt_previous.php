...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <tbody style="background:white;"> 
     ...
     <tr> 
	  <td class="center"><?php echo $i++; ?></td>
       <td class="center"><a style="color:red;" target="_blank" href="<?php echo base_url('Report/invoice_pdf/'.$row->inv_id); ?>"><?php echo $row->in_registr; ?></a><br> <?php echo $row->inv_cus; ?><br><?php echo $row->inv_cus_addres; ?><br><?php echo $row->inv_pho; ?></td>
	...
	<td class="center">
		 <form action="<?php 
                echo  base_url('Admin/edit_invoice_prev');?>" method="post" name="all-<?php echo $i;?>" class="form-horizontal">  
