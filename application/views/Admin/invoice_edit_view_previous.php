...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="" class="tip-bottom">INVOICE</a> <a href="#" class="current">Labour</a> </div>
 ...
 <form action="<?php echo base_url('Admin/invoice_pdf_ready_previous');?>" method="post" class="form-horizontal" target="_blank"> 
                <div class="widget-box">
                    <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                        <h5>INVOICE (Labour)</h5>
						 <button style="float:right;" type="submit" name="ready" value="Ready For Bill" class="btn btn-danger" style="border-radius:60px;">Save Bill</button>
                    </div>
				 ...
				 <div class="span3">
				  <div class="control-group">
				    ...
				    <div class="control-group">
                               ...
                               <div class="controls" style="margin-left:130px">
                                     <input type="text" name="jno" value="<?php echo $row->inv_job_card_no ;?>"/>
                                     <input type="hidden" name="jnoss" value="<?php echo $row->inv_job_card_no ;?>"/></div>								
                            </div>
                           <div class="control-group">
							 ...
							 <div class="control-group">
                                ...
                                <div class="controls" style="margin-left:130px">
                                     <input type="date" name="invoicedate" value="<?php echo $row->inv_inv_date;?>" readonly />
							...
							<input type="text" name="rno"  value="<?php echo $row->in_registr ;?>" id="reg" onblur="reg_number();"/>
						 ...
						 <div class="control-group">
                                ...
                                <div class="controls" style="margin-left:128px">
							<input type="text" name="mname" id="mdname"  value="<?php echo $row->inv_modl ;?>" readonly />
				    ...
				    <div class="control-group">
						...
						<input type="text" name="km"  value="<?php echo $row->inv_km ;?>" />
							...
							<div class="control-group">
                                ...
                                <div class="controls" style="margin-left:128px">
						<input type="text" name="cno" id="cno" value="<?php echo $row->inv_chassis ;?>" readonly />
							...
							<div class="control-group">
                                ...
                                <div class="controls" style="margin-left:128px">
								<input type="text" name="eno" id="eno" value="<?php echo $row->in_engine ;?>" readonly />
                                ...
                                <div class="controls" style="margin-left:130px">
                         <input type="text" name="cusname" id="cusname" value="<?php echo $row->inv_cus ;?>" readonly />
							...
							<div class="control-group">
                                ...
                                <div class="controls" style="margin-left:130px">
                                <input type="number" name="cusph" id="cusph" value="<?php echo $row->inv_pho ;?>" />
									
                                </div>								
                            </div>
							<div class="control-group">
                                <label class="control-label" style="width:120px">Customer GSTIN:</label>
                                <div class="controls" style="margin-left:130px">
                                  <input type="text" name="cusgst" id="gstinc" value="<?php echo $row->inv_cus_gstin ;?>" />
									
                                </div>								
                            </div>
								 <div class="control-group">
                                <label class="control-label" style="width:120px">Customer Address:</label>
                                <div class="controls" style="margin-left:130px">
                                  <textarea name="cusaddr" id="address" style="height:61px;resize:none;" rows="4" readonly ><?php echo $row->inv_cus_addres ;?></textarea>
								 </div>								
                            </div>
									</div>
 ...
 <div class="control-group">
                                ...
                                <div class="controls" style="margin-left:130px">
					 <!--<input type="text" name="repairty"  value="<?php echo $row->inv_repair_typ ;?>" readonly />--><select name="repairty"  style="width:165px;" >
							...
							<div class="control-group">
								...
								$adv=$row->advai;if(isset($adv)) {?>
								<select name="advname"  style="width:165px;">
							...
							<div class="control-group">
                                ...
                                <div class="controls" style="margin-left:128px">
									...
									<?php $branch_id=$row->b_id;
								$branchmm = $this->Bill_model->select_mech_by_brnch($branch_id);
								$mechi=$row->mechni;if(isset($mechi)) {?>
									<select name="mechname"  style="width:165px;">
							...
							<div class="control-group">
                                <label class="control-label" style="width:120px">Sale Date:</label>
                                <div class="controls" style="margin-left:130px">
                                    <input type="date" id="saledate" name="saledate"  placeholder="" value="<?php echo $row->inv_sale_date;?>" readonly />
	...
	<!-- <button style="float:right;margin-left:15px;" type="submit" name="print" value="Print" class="btn btn-danger" style="border-radius:60px;" onclick="return handleChange()">Print</button>-->
...
<div class="span1" style="margin-left:67px;margin-top:30px;margin-top:29px;"><a href="javascript:void(0);" id="add" ><span class="icon-plus"></span></a></div>
		...
		<option value="<?php echo $invo[$i]['lc_lab_code'];?>"><?php echo $invo[$i]['lc_lab_code'];?> [ <?php echo $invo[$i]['lc_lb_name']; ?> ]</option>
				<?php foreach($labour as $rowss) { ?> <option value="<?php echo  $rowss['labour_code']; ?>"><?php echo $rowss['labour_code']; ?> [ <?php echo $rowss['labour_title']; ?>]</option> <?php } ?>
						...
						<div class="span1"  style="margin-left:75px;margin-top:10px;"><span class="rem1"><a href="javascript:void(0);" onclick="calculate1(<?php echo $invo[$i]['lc_id'];?>);claculate_all_sums();" ><span class="icon-minus"></span></a></span></div>
					</div>
					</div>	
						<?php }	?>
						<?php if($i>0)	{ 
				...
				<?php foreach($labour as $rowss) { ?> <option value="<?php echo  $rowss['labour_code']; ?>"><?php echo $rowss['labour_code']; ?> [ <?php echo $rowss['labour_title']; ?>]</option> <?php } ?>
						...
						<div class="span1" style="margin-left: 10px;"><input  type="text" class="lamt" name="lamt[]" id="total-<?php echo $j;?>" value="<?php if(isset($invo[$i])) { echo $invo[$i]['lc_amount'];} ?>"  style="width:115px;" readonly /></div>
						<div class="span1"  style="margin-left:75px;margin-top:10px;"><span class="rem4" id="" ><a href="javascript:void(0);" onclick="calculate2(<?php echo $invo[$i]['lc_id'];?>);claculate_all_sums();"><span class="icon-minus"></span></a></span></div>
					</div>
					</div>
						</div>	
				<?php }	?>
